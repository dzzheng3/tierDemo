        ...
        for (int i = 0; i < tiers.size(); i++) {
            ...
            switch (tier.getCircleState()) {
                case FINISH:
                    ...
                    CircleView tierCircleView = tierView.getTierCircleView(this, mainView);
                ...
                case UNFINISH:
                    ...
                    tierView.getTierCircleView(this, mainView);
                    break;
                case ONPROGRESS:
                    ...
                    if (tier.getTierProgress() == 0) {
                        tierView.getTierCircleView(this, mainView).setProgressWithAnimation(5);
                    } else {
                        tierView.getTierCircleView(this, mainView).setProgressWithAnimation(
